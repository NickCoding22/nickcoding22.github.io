        ...
        <div>
            ...
            >
                <div className={mainStyle}>
                    ...
                    <div className={`flex flex-col rounded-bl-md rounded-br-md overflow-auto max-h-[548px] ${mobile ? 'py-6 px-4' : 'px-10 pt-6 pb-7'} bg-white border-x-4 border-b-4 border-black text-black text-left`}>
